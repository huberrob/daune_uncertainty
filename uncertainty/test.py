...
#unc.get_uncertainty('SAL')
#unc.set_spike_qc('TEMP')


print(unc.data.resample('5min').apply(lambda d: d['PRES'].corr(d['TEMP'])))
print(unc.data.resample('5min').apply(lambda d: unc.get_slope(d['TEMP'],d['COND'])))

print(unc.data[unc.data['PRES_var'].notnull()][['PRES','PRES_var','PRES_syst','PRES_unc']].head(20))